...
const UpdateProfilePictureScreen = ({ navigation }) => {
    ...
    const [profilePicture, setProfilePicture] = useState(user.profilePicture ? `http://192.168.172.192:5000/${user.profilePicture}` : null);
    ...
    const handleUpdateProfilePicture = async () => {
        ...
        try {
            const res = await axios.put('http://192.168.172.192:5000/api/user/updateProfilePicture', formData, {
                headers: {
            ...
            setUser(res.data);
            setProfilePicture(res.data.profilePicture ? `http://192.168.172.192:5000/${res.data.profilePicture}` : null);
